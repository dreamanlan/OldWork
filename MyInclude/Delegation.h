/********************************************************************************
*	文件名：	Delegation.h
*	全路径：	\Common\Delegation.h
*	创建人：	兰翔
*	创建时间：	2008 年 4 月 11 日
*
*	功能说明：	无需动态内存分配的委托机制，类似C#中delegate关键字的功能。
*	修改记录：
*********************************************************************************/
...
#undef new
#ifndef need_pop_macro_new
#define need_pop_macro_new
#endif
#endif

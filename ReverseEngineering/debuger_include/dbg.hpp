...
// This function can be used to temporarily modify the process state from a plugin.
...
//      p_thid   - ptr to new thread id. may be NULL.
...
#define DBGINV_ALL      (-1)    // invalidate everything
...
// Retrieve/store exception information

...
struct generic_linput_t
{
  ...
  virtual idaapi ~generic_linput_t(void) {}
};
...
idaman void ida_export checkdspace(uint32 space); // if there is less than
                                                // 'space' on the current disk
                                                // warns the user
int     lowdiskgo(uint32 space);                // if there is less than
                                                // 'space' on the current disk

...
idaman asize_t ida_export get_data_elsize(ea_t ea, flags_t F, const typeinfo_t *ti=NULL);
...
idaman asize_t ida_export get_data_type_size(flags_t F, const typeinfo_t *ti);

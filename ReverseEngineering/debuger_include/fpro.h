...
idaman int ida_export qvfprintf(FILE *fp, const char *fmt, va_list va); // out to FILE*
idaman int ida_export qvprintf(const char *fmt, va_list va);    // out to stdout
idaman int ida_export qveprintf(const char *fmt, va_list va);   // out to stderr

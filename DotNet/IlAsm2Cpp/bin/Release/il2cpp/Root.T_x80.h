...
namespace Root
{
	...
	public 
	ref class T_x80  : System::Windows::Forms::Control , Root::T_x75
	{
		ref class T_x1;
	internal:
		[StructLayout(LayoutKind::Auto , CharSet=CharSet::Ansi)]
		...
		public:
			T_x1();
		public:
			virtual void M_x2(System::String^ A_0) sealed  = Reflector::CodeModel::IFormatter::Write;
			//Reflector::CodeModel::IFormatter^::Write by M_x2
		public:
			virtual void M_x12(System::String^ A_0) sealed  = Reflector::CodeModel::IFormatter::WriteDeclaration;
			//Reflector::CodeModel::IFormatter^::WriteDeclaration by M_x12
		public:
			virtual void M_x13(System::String^ A_0) sealed  = Reflector::CodeModel::IFormatter::WriteKeyword;
		...
		public:
			virtual void M_x1(System::String^ A_0) sealed  = Reflector::CodeModel::IFormatter::WriteLiteral;
		...
		public:
			virtual void M_x5() sealed  = Reflector::CodeModel::IFormatter::WriteOutdent;
	...
	private:
		System::Windows::Forms::RichTextBox^ F_x12;
	public:

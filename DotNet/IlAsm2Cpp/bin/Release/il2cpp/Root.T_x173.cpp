...
inline static Root::T_x173::T_x173()
{
	//temp variables , should be optimized by C++/cli compiler.
	Root::T_x173^ Temp_0 = nullptr;
	//local variables.
	//method body ------- 
	IL_0000:                                                                        //ldnull
	IL_0001:            Temp_0=gcnew Root::T_x173(safe_cast<array<Reflector::CodeModel::IType^>^>(nullptr));//newobj				void Root::T_x173::.ctor(array<Reflector::CodeModel::IType^>^)
	IL_0006:            Root::T_x173::F_x1=safe_cast<Reflector::CodeModel::ITypeCollection^>(Temp_0);//stsfld				Reflector::CodeModel::ITypeCollection^ Root::T_x173 F_x1
	IL_000b:            return;                                                     //ret

}
inline Root::T_x173::T_x173(array<Reflector::CodeModel::IType^>^ A_0)
{
	//temp variables , should be optimized by C++/cli compiler.
	//local variables.
	//method body ------- 
	...
	IL_0006:                                                                        //ldarg.0
	IL_0007:                                                                        //ldarg.1
	IL_0008:            this->F_x2=A_0;                                             //stfld				array<Reflector::CodeModel::IType^>^ Root::T_x173 F_x2
	IL_000d:            return;                                                     //ret

}
inline void Root::T_x173::CopyTo(System::Array^ array_1,System::Int32 index)
{
	//temp variables , should be optimized by C++/cli compiler.
	...
	//method body ------- 
	IL_0000:                                                                        //ldarg.0
	IL_0001:            Temp_0=this->F_x2;                                          //ldfld				array<Reflector::CodeModel::IType^>^ Root::T_x173 F_x2
	IL_0006:            if(Temp_0==nullptr)goto IL_0019;                            //brfalse.s				IL_0019
	IL_0008:            goto IL_000a;                                               //br.s				IL_000a
	IL_000a:                                                                        //ldarg.0
	IL_000b:            Temp_1=this->F_x2;                                          //ldfld				array<Reflector::CodeModel::IType^>^ Root::T_x173 F_x2
	IL_0010:                                                                        //ldarg.1
	IL_0011:                                                                        //ldarg.2
...
inline System::Collections::IEnumerator^ Root::T_x173::GetEnumerator()
{
	//temp variables , should be optimized by C++/cli compiler.
	array<Reflector::CodeModel::IType^>^ Temp_0 = nullptr;
	array<Reflector::CodeModel::IType^>^ Temp_1 = nullptr;
	...
	IL_0010:                                                                        //ldarg.0
	IL_0011:            Temp_1=this->F_x2;                                          //ldfld				array<Reflector::CodeModel::IType^>^ Root::T_x173 F_x2
...
inline Reflector::CodeModel::ITypeCollection^ Root::T_x173::M_x1()
{
	//temp variables , should be optimized by C++/cli compiler.
	Reflector::CodeModel::ITypeCollection^ Temp_0 = nullptr;
	//local variables.
	//method body ------- 
	IL_0000:            Temp_0=Root::T_x173::F_x1;                                  //ldsfld				Reflector::CodeModel::ITypeCollection^ Root::T_x173 F_x1
	IL_0005:            return Temp_0;                                              //ret

}
inline System::Int32 Root::T_x173::M_x1(Reflector::CodeModel::IType^ A_0)
//Reflector::CodeModel::ITypeCollection^::IndexOf by M_x1
{
	...
	IL_0016:                                                                        //pop
	IL_0017:                                                                        //ldarg.0
	IL_0018:            Temp_1=this->F_x2;                                          //ldfld				array<Reflector::CodeModel::IType^>^ Root::T_x173 F_x2
	IL_001d:                                                                        //ldarg.1
	IL_001e:                                                                        //ldc.i4.0
	IL_001f:                                                                        //ldarg.0
	IL_0020:            Temp_2=this->F_x2;                                          //ldfld				array<Reflector::CodeModel::IType^>^ Root::T_x173 F_x2
...
inline void Root::T_x173::M_x1(System::Collections::ICollection^ A_0)
...
inline Reflector::CodeModel::IType^ Root::T_x173::M_x1(System::Int32 A_0)
...
inline void Root::T_x173::M_x1(System::Int32 A_0,Reflector::CodeModel::IType^ A_1)
...
inline void Root::T_x173::M_x12(Reflector::CodeModel::IType^ A_0)
...
inline void Root::T_x173::M_x13(Reflector::CodeModel::IType^ A_0)
...
inline System::Boolean Root::T_x173::M_x2(Reflector::CodeModel::IType^ A_0)
//Reflector::CodeModel::ITypeCollection^::Contains by M_x2
{
	...
	IL_000f:                                                                        //ldarg.0
	IL_0010:            Temp_1=this->F_x2;                                          //ldfld				array<Reflector::CodeModel::IType^>^ Root::T_x173 F_x2
	IL_0015:                                                                        //ldarg.1
	IL_0016:                                                                        //ldc.i4.0
	IL_0017:                                                                        //ldarg.0
	IL_0018:            Temp_2=this->F_x2;                                          //ldfld				array<Reflector::CodeModel::IType^>^ Root::T_x173 F_x2
...
inline void Root::T_x173::M_x2(System::Int32 A_0)
...
inline void Root::T_x173::M_x2(System::Int32 A_0,Reflector::CodeModel::IType^ A_1)
...
inline System::Int32 Root::T_x173::Count::get()
{
	//temp variables , should be optimized by C++/cli compiler.
	array<Reflector::CodeModel::IType^>^ Temp_0 = nullptr;
	array<Reflector::CodeModel::IType^>^ Temp_1 = nullptr;
	...
	IL_000c:                                                                        //ldarg.0
	IL_000d:            Temp_1=this->F_x2;                                          //ldfld				array<Reflector::CodeModel::IType^>^ Root::T_x173 F_x2
	IL_0012:            Temp_2=Temp_1->Length;                                      //ldlen
	IL_0013:                                                                        //conv.i4
	IL_0014:            return Temp_2;                                              //ret

}
inline System::Boolean Root::T_x173::IsSynchronized::get()
{
	//temp variables , should be optimized by C++/cli compiler.
	array<Reflector::CodeModel::IType^>^ Temp_0 = nullptr;
	array<Reflector::CodeModel::IType^>^ Temp_1 = nullptr;
...
inline System::Object^ Root::T_x173::SyncRoot::get()
{
	//temp variables , should be optimized by C++/cli compiler.
	array<Reflector::CodeModel::IType^>^ Temp_0 = nullptr;
	array<Reflector::CodeModel::IType^>^ Temp_1 = nullptr;

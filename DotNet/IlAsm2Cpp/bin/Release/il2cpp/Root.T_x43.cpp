...
inline void Root::T_x43::M_x1()
{
	//temp variables , should be optimized by C++/cli compiler.
	System::Type^ Temp_0 = nullptr;
	System::Object^ Temp_1 = nullptr;
	Reflector::CodeModel::IPropertyReference^ Temp_2 = nullptr;
	//local variables.
	...
	IL_0021:                                                                        //ldloc.0
	IL_0022:                                                                        //ldarg.0
	IL_0023:            Temp_2=this->M_x12();                                       //call				Reflector::CodeModel::IPropertyReference^ Root::T_x43::M_x12()
...
inline void Root::T_x43::M_x1(Reflector::CodeModel::IPropertyReference^ A_0)
{
	//temp variables , should be optimized by C++/cli compiler.
	...
	IL_0013:                                                                        //ldarg.0
	IL_0014:                                                                        //ldarg.1
	IL_0015:            Temp_0=Root::T_x115::M_x13(A_0);                            //call				System::String^ Root::T_x115::M_x13(Reflector::CodeModel::IPropertyReference^)
	IL_001a:                                                                        //ldstr				L"\x0D2C\x542E\x1130"
	IL_001f:                                                                        //ldloc				V_1
	IL_0023:            Temp_1=a(L"\x0D2C\x542E\x1130",V_1);                        //call				System::String^ undefined_type::a(System::String^,System::Int32)
	IL_0028:                                                                        //ldarg.1
	...
	IL_0038:                                                                        //ldstr				L"\x0D2C\x522E"
	IL_003d:                                                                        //ldloc				V_1
	IL_0041:            Temp_4=a(L"\x0D2C\x522E",V_1);                              //call				System::String^ undefined_type::a(System::String^,System::Int32)
...
inline Reflector::CodeModel::IPropertyReference^ Root::T_x43::M_x12()
{
	//temp variables , should be optimized by C++/cli compiler.
	...
	IL_0006:                                                                        //castclass				Reflector::CodeModel::IPropertyReference
	IL_000b:            return safe_cast<Reflector::CodeModel::IPropertyReference^>(Temp_0);//ret

}
inline void Root::T_x43::M_x2()
{
	//temp variables , should be optimized by C++/cli compiler.
	//local variables.
	//method body ------- 
	IL_0000:                                                                        //ldarg.0
	IL_0001:            this->M_x1();                                               //call				void Root::T_x43::M_x1()
	IL_0006:            return;                                                     //ret

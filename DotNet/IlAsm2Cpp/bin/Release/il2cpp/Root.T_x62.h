...
namespace Root
{
	...
	public 
	ref class T_x62  : Reflector::CodeModel::ILanguage
	{
		ref class T_x1;
	internal:
		[StructLayout(LayoutKind::Auto , CharSet=CharSet::Ansi)]
		...
		internal:
			[StructLayout(LayoutKind::Auto , CharSet=CharSet::Ansi)]
			ref class T_x1_4  : Reflector::CodeModel::IFormatter
			{
			private:
		...
		private:
			System::String^ M_x2(Reflector::CodeModel::ITypeReference^ A_0);
		private:
		...
		private:
			void M_x1(Reflector::CodeModel::IVariableDeclaration^ A_0,Reflector::CodeModel::IFormatter^ A_1,System::Boolean% A_2);
		private:
			void M_x1(Reflector::CodeModel::IVariableDeclarationExpression^ A_0,Reflector::CodeModel::IFormatter^ A_1,System::Boolean% A_2);
		private:
			void M_x1(Reflector::CodeModel::IStatement^ A_0,Reflector::CodeModel::IFormatter^ A_1,System::Boolean% A_2);
		private:
			void M_x1(Reflector::CodeModel::IStatementCollection^ A_0,Reflector::CodeModel::IFormatter^ A_1,System::Boolean% A_2);
		private:
		...
		private:
			void M_x1(System::String^ A_0,Reflector::CodeModel::IFormatter^ A_1,System::String^ A_2,System::Object^ A_3);
		};
	public:

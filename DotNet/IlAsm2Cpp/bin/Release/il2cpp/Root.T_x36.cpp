...
inline Reflector::CodeModel::IFieldReference^ Root::T_x36::M_x1()
{
	//temp variables , should be optimized by C++/cli compiler.
	...
	IL_0006:                                                                        //castclass				Reflector::CodeModel::IFieldReference
	IL_000b:            return safe_cast<Reflector::CodeModel::IFieldReference^>(Temp_0);//ret

}
inline void Root::T_x36::M_x1(Reflector::CodeModel::IFieldReference^ A_0)
{
	//temp variables , should be optimized by C++/cli compiler.
	...
	IL_0013:                                                                        //ldarg.0
	IL_0014:                                                                        //ldarg.1
	IL_0015:            Temp_0=Root::T_x115::M_x2(A_0);                             //call				System::String^ Root::T_x115::M_x2(Reflector::CodeModel::IFieldReference^)
...
inline void Root::T_x36::M_x12()
{
	...
	IL_0021:                                                                        //ldloc.0
	IL_0022:                                                                        //ldarg.0
	IL_0023:            Temp_2=this->M_x1();                                        //call				Reflector::CodeModel::IFieldReference^ Root::T_x36::M_x1()
...
inline void Root::T_x36::M_x2()
{
	//temp variables , should be optimized by C++/cli compiler.
	//local variables.
	//method body ------- 
	IL_0000:                                                                        //ldarg.0
	IL_0001:            this->M_x12();                                              //call				void Root::T_x36::M_x12()
	IL_0006:            return;                                                     //ret

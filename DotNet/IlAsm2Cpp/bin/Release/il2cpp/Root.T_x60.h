...
namespace Root
{
	...
	public 
	ref class T_x60  : Reflector::CodeModel::ILanguage
	{
		ref class T_x1;
	internal:
		[StructLayout(LayoutKind::Auto , CharSet=CharSet::Ansi)]
		...
		internal:
			[StructLayout(LayoutKind::Auto , CharSet=CharSet::Ansi)]
			ref class T_x1_3  : System::Collections::IEnumerable
			{
			private:
			...
			private:
				System::Collections::ArrayList^ F_x12;
			public:
				T_x1_3(System::Collections::ICollection^ A_0,Reflector::CodeModel::INamespace^ A_1);
			public:
		...
		internal:
			[StructLayout(LayoutKind::Auto , CharSet=CharSet::Ansi)]
			ref class T_x13  : Reflector::CodeModel::IFormatter
			{
			private:
		...
		internal:
			...
			public:
				System::Boolean M_x1();
			public:
				virtual void M_x1(Reflector::CodeModel::IPointerType^ A_0) override;
			public:
				virtual void M_x1(Reflector::CodeModel::IAddressOfExpression^ A_0) override;
			public:
				T_x2();
			};
		private:
		...
		private:
			System::Collections::ArrayList^ F_x5;
		private:
			System::Boolean F_x9;
		private:
			System::Boolean F_x4;
		...
		private:
			Reflector::CodeModel::IParameterDeclaration^ F_x11;
		private:
			Reflector::CodeModel::ITypeDeclaration^ F_x10;
		private:
			array<System::String^>^ F_x7;
		public:
		...
		public:
			virtual void M_x8(Reflector::CodeModel::ITypeDeclaration^ A_0) sealed  = Reflector::CodeModel::ILanguageWriter::WriteTypeDeclaration;
			//Reflector::CodeModel::ILanguageWriter^::WriteTypeDeclaration by M_x8
		public:
			virtual void M_x12(Reflector::CodeModel::IFieldDeclaration^ A_0) sealed  = Reflector::CodeModel::ILanguageWriter::WriteFieldDeclaration;
			//Reflector::CodeModel::ILanguageWriter^::WriteFieldDeclaration by M_x12
		public:
			virtual void M_x5(Reflector::CodeModel::IMethodDeclaration^ A_0) sealed  = Reflector::CodeModel::ILanguageWriter::WriteMethodDeclaration;
			//Reflector::CodeModel::ILanguageWriter^::WriteMethodDeclaration by M_x5
		public:
		...
		private:
			void M_x13(Reflector::CodeModel::IType^ A_0,Reflector::CodeModel::IFormatter^ A_1);
		private:
		...
		private:
			void M_x2(System::Collections::ICollection^ A_0,Reflector::CodeModel::IFormatter^ A_1);
		private:
			void M_x1(System::Collections::ICollection^ A_0,Reflector::CodeModel::IFormatter^ A_1);
		public:
			virtual void M_x13(Reflector::CodeModel::IExpression^ A_0) sealed  = Reflector::CodeModel::ILanguageWriter::WriteExpression;
			//Reflector::CodeModel::ILanguageWriter^::WriteExpression by M_x13
		private:
			void M_x13(Reflector::CodeModel::IExpression^ A_0,Reflector::CodeModel::IFormatter^ A_1);
		private:
		...
		private:
			void M_x1(System::IFormattable^ A_0,Reflector::CodeModel::IFormatter^ A_1,System::Boolean A_2);
		private:
			void M_x1(Reflector::CodeModel::IFormatter^ A_0,System::String^ A_1,System::String^ A_2,System::String^ A_3);
		private:
			void M_x1(Reflector::CodeModel::ITypeReference^ A_0,Reflector::CodeModel::IFormatter^ A_1,System::String^ A_2,System::Object^ A_3);
		private:
			void M_x1(Reflector::CodeModel::ITypeReference^ A_0,Reflector::CodeModel::IFormatter^ A_1,System::String^ A_2,System::Object^ A_3,array<Reflector::CodeModel::IType^>^ A_4);
		private:
		...
		public:
			virtual void M_x2(Reflector::CodeModel::IStatement^ A_0) sealed  = Reflector::CodeModel::ILanguageWriter::WriteStatement;
			//Reflector::CodeModel::ILanguageWriter^::WriteStatement by M_x2
		private:
		...
		private:
			void M_x1(Reflector::CodeModel::IBlockStatement^ A_0,Reflector::CodeModel::IFormatter^ A_1,System::Boolean A_2);
		private:
		...
		private:
			void M_x12(System::String^ A_0,Reflector::CodeModel::IFormatter^ A_1);
		private:
			static System::String^ M_x1(System::String^ A_0,System::Char A_1);
		private:
			Reflector::CodeModel::IFieldReference^ M_x1(Reflector::CodeModel::IEventDeclaration^ A_0);
		private:
			Reflector::CodeModel::IFieldReference^ M_x1(Reflector::CodeModel::IEventDeclaration^ A_0,Reflector::CodeModel::IMethodDeclaration^ A_1,System::String^ A_2);
		private:
		...
		private:
			Reflector::CodeModel::IBlockStatement^ M_x1(Reflector::CodeModel::IBlockStatement^ A_0);
		private:
			System::Boolean M_x1(Reflector::CodeModel::IStatement^ A_0);
		private:
			System::Boolean M_x12(Reflector::CodeModel::IExpression^ A_0);
		private:
			System::Boolean M_x8(Reflector::CodeModel::IMethodDeclaration^ A_0);
		private:
			System::Boolean M_x13(Reflector::CodeModel::IMethodDeclaration^ A_0);
		private:
			System::Boolean M_x12(Reflector::CodeModel::IMethodDeclaration^ A_0);
		private:
			System::Boolean M_x2(Reflector::CodeModel::IFieldDeclaration^ A_0);
		private:
			System::Boolean M_x1(Reflector::CodeModel::IMethodDeclaration^ A_0,Reflector::CodeModel::ITypeDeclaration^ A_1);
		private:
			static System::Boolean M_x1(Reflector::CodeModel::IType^ A_0);
		private:
			static System::Boolean M_x2(Reflector::CodeModel::IMethodDeclaration^ A_0);
		private:
			System::Boolean M_x1(Reflector::CodeModel::ICatchClause^ A_0);
		private:
			System::Boolean M_x13(Reflector::CodeModel::ITypeDeclaration^ A_0);
		private:
			System::Boolean M_x12(Reflector::CodeModel::ITypeDeclaration^ A_0);
		private:
			System::Boolean M_x2(Reflector::CodeModel::IExpression^ A_0);
		private:
		...
		private:
			static System::Int32 M_x1(Reflector::CodeModel::IMethodDeclaration^ A_0);
		private:
			static System::Int32 M_x1(Reflector::CodeModel::IExpression^ A_0);
		private:
			static System::Int32 M_x1(Reflector::CodeModel::ICustomAttribute^ A_0);
		private:
			static array<System::String^>^ M_x1(System::Collections::IEnumerable^ A_0);
		private:
			System::Boolean M_x1(System::String^ A_0);
		private:
			System::Boolean M_x1(Reflector::CodeModel::IFieldDeclaration^ A_0);
		private:
			static array<Reflector::CodeModel::IType^>^ M_x2(Reflector::CodeModel::ITypeDeclaration^ A_0);
		private:
			static Reflector::CodeModel::IExpressionCollection^ M_x1(Reflector::CodeModel::IMethodInvokeExpression^ A_0);
		private:
			System::Collections::ArrayList^ M_x1(Reflector::CodeModel::ITypeDeclaration^ A_0);
		private:
